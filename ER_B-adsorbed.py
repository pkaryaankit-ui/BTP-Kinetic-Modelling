# ================================================================
#   ALDOL CONDENSATION: ELEY-RIDEAL (B adsorbed) MODEL FITTING
...
file_path = 'BTP data  - Sheet1.csv'  # <-- Correct file for Aldol Condensation
...
#
print("\n\n=====================================================================")
print("--- PART 1: Global Simultaneous Fit for Eley-Rideal (B ads) ---")
print("=====================================================================")

def fitting_rate_law_er_B(t, XA, T, M, CA0, A_s, Ea, K_A, K_B):
    """
    Defines the ODE for the Eley-Rideal model with B (Acetone) adsorbed.
    k_s is now calculated from A_s and Ea inside this function.
    """
    # Calculate k_s from Arrhenius parameters
    k_s = A_s * np.exp(-Ea / (R * T))

    C_A = CA0 * (1 - XA); C_B = CA0 * (M - XA) # A=Benzaldehyde, B=Acetone
...
def sum_of_squared_errors_er_B(params):
    """
...
print("\n--- Global Simultaneous Fit Results (Eley-Rideal, B ads) ---")
...
fig1.suptitle('PART 1: Eley-Rideal (Acetone ads) Model (Global Fit)', fontsize=18)
...
fig2.suptitle('PART 2: Eley-Rideal (Acetone ads) Global Fit Model Validation', fontsize=18)
...
#
print("\n\n=======================================================")
print("--- PART 3: Final Eley-Rideal (Acetone ads) Results Summary ---")
print("=======================================================")
...
for temp, params in fitted_params_map.items():
    ...
    print(f"Temp: {temp} K")
    print(f"  K_A (Benzaldehyde const): {ka_val:.4f} ± {ka_val*error_margin:.4f}")
